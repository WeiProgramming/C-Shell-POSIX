...
* It returns -1 if end-of-file is encountered (or if the word is "logout");
...
integer is (-1).
(2) If the word collected is "logout", then w still points to "logout",
but -1 (rather than the expected 6) is returned.
